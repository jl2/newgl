...
(defmethod newgl:initialize ((object mp3-fft-animation))
  ...
  (with-slots (current-stream the-mp3 mixer mp3-filename song-duration start-time) object
...
(defmethod newgl:update ((object mp3-fft-animation) current-time)
  ...
  (with-slots (start-time window-buffer song-duration the-mp3 left-fft-data right-fft-data) object
